...
number_of_years_until_today = 2020 - birthyear
age = 0 #je calcule le nombre d'années qui s'est écoulées entre l'année de naissance de l'utilisateur et aujourd'hui
number_of_years_until_today.times do #je crée une boucle de répétition qui va se répéter le nombre de fois qu'il y a eu d'années qui s'est écoulé depuis sa naissance
	...
	age = age + 1  #je lui demande d'ajouter à chaque fois un à chaque année qui passe en partant de l'année de naissance
	puts "#{birthyear} : tu avais #{age} ans cette année-là." #je lui demande d'afficher le résultat à l'écran à chaque fois
