...
number_of_years_until_today.times do #je crée une boucle de répétition qui va se répéter le nombre de fois qu'il y a eu d'années qui s'est écoulé depuis sa naissance
	...
	elsif number_of_years_until_today - 1 == age + 1 #je pose la condition "si à une année n le nombre d'années qu'il reste à compter est égal à l'âge de l'utilisateur"
		number_of_years_until_today = number_of_years_until_today - 1 
		age = age + 1 
		puts "Il y a #{number_of_years_until_today} ans tu avais la moitié de l'âge que tu as aujourd'hui."
